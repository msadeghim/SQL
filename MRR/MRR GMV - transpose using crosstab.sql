...
select nr.jmonth,
       unnest(array['new','resurrected','retained','extraction','contraction','churn']) as metric,
       unnest(array[nr.new, nr.resurrected,retained,ec.extraction, ec.contraction,ca.churn]) as value
