...
select unnest(array[nr.jmonth||' 1new', nr.jmonth||' 2resurrected', nr.jmonth||' 3extraction', nr.jmonth||' 4contraction', nr.jmonth||' 5churn']) as type,
       round(unnest(array[nr.new, nr.resurrected,
